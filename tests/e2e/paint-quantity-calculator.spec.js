...
const SVC_URL = "https://appadaycreator.com/paint-quantity-calculator/";
const SVC_NAME = "ペンキ・塗料必要量計算";

test.describe("ペンキ・塗料必要量計算 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("paint-quantity-calculator");
